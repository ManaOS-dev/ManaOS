...
impl Scheduler {
    ...
    pub(super) fn next_active_user_task_id(&self) -> Option<u64> {
    ...
    pub(super) fn has_active_user_tasks(&self) -> bool {
    ...
    pub(super) fn prepare_one_shot_user_task(&mut self, task_id: u64) -> Option<OneShotUserTask> {
    ...
    pub(super) fn finish_current_task(&mut self, exit_code: u64) -> Option<UserTaskExit> {
    ...
    pub(super) fn take_finished_user_exit(&mut self) -> Option<UserTaskExit> {
    ...
    pub(super) fn reclaim_finished_user_resources(
        &mut self,
        frame_allocator: &mut PhysicalFrameAllocator,
        task_id: u64,
