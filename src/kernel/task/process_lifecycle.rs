...
fn run_user_task_until_kernel_return(
    ...
    crate::log_info!(
        "task",
        "Installed user task kernel stack: task={} address_space={:#x} top={:#x} kernel_stack_top_typed=true architecture_stack_installer_typed=true privilege_stack_top_typed=true",
        task_id,
