                    ...
                    TaskKind::Kernel => SchedulerTaskSnapshot::new_kernel(
                        ...
                        TaskStatusDiagnosticsSnapshot::new(
                            TaskRuntimeDiagnosticsSnapshot::new(
                                ...
                                0,
                                0,
                                UserTrapFrameDiagnosticsSnapshot::new(0, false, false, 0, 0, 0),
                            ),
                        ...
                        SchedulerTaskSnapshot::new_user(
                            ...
                            TaskStatusDiagnosticsSnapshot::new(
                                TaskRuntimeDiagnosticsSnapshot::new(
                                    ...
                                    task.kernel_stack.is_some(),
                                    user_runtime.resume_handoff_count,
                                    user_runtime.last_resume_address_space_root,
                                    user_runtime.last_resume_kernel_stack_top,
                                    UserTrapFrameDiagnosticsSnapshot::new(
                                        ...
                                        user_runtime.runtime_trap_frame_record_count,
                                        user_runtime.restored_user_trap_frame_bytes,
                                        user_runtime.runtime_trap_frame_restore_count,
                                    ),
                                ),
                                task_exit_status_diagnostics(task),
