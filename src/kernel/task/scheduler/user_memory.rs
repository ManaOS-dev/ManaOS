...
impl Scheduler {
    pub(in crate::kernel::task::scheduler) fn process_current_user_break(
        ...
        crate::log_info!(
            "syscall",
            "brk -> task={} requested={:#x} heap_base={:#x} previous={:#x} next={:#x} mapped_end={:#x} mapped_pages={} brk_request_typed=true heap_mapped_end_page_start_typed=true",
            task_id,
            request.as_u64(),
    ...
    pub(in crate::kernel::task::scheduler) fn process_current_user_mapping(
        ...
        crate::log_info!(
            "syscall",
            "mmap -> task={} requested={:#x} start={:#x} length={} pages={} protection={:#x} flags={:#x} placement={} source={} active_pages={} file_private_records={} page_count_typed=true mapping_request_typed=true mapping_length_typed=true mapping_start_typed=true mapping_range_typed=true fixed_placement_end_typed={}",
            task_id,
            ...
            request.placement().uses_fixed_address()
        );
