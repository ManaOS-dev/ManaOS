//! Storage registry state and service facade functions.

use super::{
    advanced_host_controller_interface, file_allocation_table, guid_partition_table, partition, pci,
};
...
use super::pci::PciConfigurationAccess;
...
pub(in crate::kernel::driver::storage) fn set_selected_partition(
    partition: guid_partition_table::GuidPartitionTablePartition,
) {
...
pub(in crate::kernel::driver::storage) fn register_storage_device(
    id: StorageDeviceId,
    sector_size: usize,
