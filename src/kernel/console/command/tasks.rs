...
pub(super) fn run(
    ...
    output.push(format!(
        "preemption: state={} enabled={} switches={} timer_user_preemptions={} user_entries={} one_shot_user_entries={} timer_user_entries={} timer_user_entries_from_preempted_user={} user_resumes={} user_sleep_blocks={} user_sleep_wakes={} user_waitpid_blocks={} user_waitpid_wakes={} user_read_blocks={} user_read_wakes={} finished={} pending_user_exits={} return_window_closes={}",
        ...
        diagnostics.timer_user_entries_from_preempted_user(),
    ...
    output.push(format!(
        "resources: reclaimed_user_resource_records={} reclaimed_user_address_spaces={} reclaimed_user_pages={} reclaimed_user_page_table_pages={} reclaimed_user_kernel_stacks={} reclaimed_kernel_stack_writable_pages={} reclaimed_kernel_stack_virtual_pages={} address_space_reclaim_guard_checks={} scheduler_transition_invariant_checks={}",
...
fn push_task_snapshot(output: &mut CommandOutput, snapshot: &SchedulerTaskSnapshot) {
    output.push(format!(
        ...
        snapshot.runtime_trap_frame_restore_count(),
