...
pub fn verify_memory_address_wrapper_rules() -> bool {
    ...
    if passed {
        crate::log_info!(
            "memory",
            "Memory address wrapper self-checks passed: user_virtual_address=true user_page_start=true user_virtual_range=true user_range_page_bounds=true frame_count=true page_count=true"
        );
    } else {
        crate::log_error!(
            "memory",
            "Memory address wrapper self-checks failed: user_virtual_address={} user_page_start={} user_virtual_range={} user_range_page_bounds={} frame_count={} page_count={}",
