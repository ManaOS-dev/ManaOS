...
- [ ] Add remaining typed page-aligned address wrappers where alignment is required by construction beyond user page starts, dynamic kernel virtual range starts, and scheduler-owned kernel stack guard/writable starts.
