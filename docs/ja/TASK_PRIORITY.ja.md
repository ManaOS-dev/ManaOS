...
1. smoke-started userland shell の standard input を keyboard-backed stdin へ接続する。
2. keyboard-backed read の間も `exit` または EOF まで shell task を維持する。
3. experimental user shell に QEMU で入る方法と抜ける方法を document する。
