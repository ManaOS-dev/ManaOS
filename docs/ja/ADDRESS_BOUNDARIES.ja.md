...
- `PageCount`: virtual range reservation または user stack allocation 前の non-zero 4 KiB page count。
...
- `PageCount`: kernel virtual range allocator API と user stack API に渡す non-zero 4 KiB page count。
