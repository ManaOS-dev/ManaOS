...
- `PageCount` / `KernelVirtualRange`: non-zero virtual page count と future dynamic mapping 用 higher-half kernel virtual range。
...
- `PageCount`: kernel virtual range allocator API に渡す non-zero virtual page count。
