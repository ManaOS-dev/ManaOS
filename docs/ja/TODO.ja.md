...
残っています。parent-exit-while-child-lives smoke は initial-process reparenting policy まで確認します。
残りは descriptor inheritance enforcement、finished child resource reclamation policy、reaping state です。
