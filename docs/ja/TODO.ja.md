...
EOF 終了 smoke、keyboard-backed stdin の smoke-started user shell standard input 接続は完了済みです。
post-shell kernel console availability smoke も完了済みです。残りは keyboard-backed read 中の
