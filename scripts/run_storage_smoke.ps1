...
$expectedPatterns = @(
    ...
    "mmap -> task=.* pages=3 .*placement=any .*page_count_typed=true mapping_request_typed=true mapping_start_typed=true",
    ...
    "mmap -> task=.* requested=0x600000008000 start=0x600000008000 length=4096 pages=1 .*flags=0x100022 placement=fixed_noreplace .*active_pages=1 .*mapping_request_typed=true mapping_start_typed=true",
    "User mapping fixed replacement prepared: start=0x600000008000 pages=1 records=0 active_pages=0",
    "mmap -> task=.* requested=0x600000008000 start=0x600000008000 length=4096 pages=1 .*flags=0x32 placement=fixed_replace .*active_pages=1 .*mapping_request_typed=true mapping_start_typed=true",
    ...
    "mmap -> task=.* length=4096 pages=1 protection=0x1 flags=0x2 placement=any source=file_private active_pages=1 file_private_records=1 .*mapping_request_typed=true mapping_start_typed=true",
