...
$expectedPatterns = @(
    ...
    "mouse_vector\s+= 44",
    "Local APIC MMIO mapped: address=0x[0-9a-f]+ size=4096 pages=1 page_count_typed=true physical_page_start_typed=true",
    ...
    "IOAPIC MMIO mapped: address=0x[0-9a-f]+ size=4096 pages=1 page_count_typed=true physical_page_start_typed=true",
