...
$expectedPatterns = @(
    ...
    "reclaimed_user_pages\s+= 12",
    "reclaimed_user_page_table_pages\s+= 14",
    ...
    "ahci_dma\s+= [0-9]+",
    "Tasks command smoke passed: command=`"tasks`" output_lines=17",
