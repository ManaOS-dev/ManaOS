...
$expectedPatterns = @(
    ...
    "IOAPIC redirection staging verified: entries=3 staged=3 readback_matches=true routing_active=false masked=true ioapic_version=0x[0-9a-f]+ max_redirection_entry=[1-9][0-9]* out_of_range_entries=0 timer_low_readback=0x[0-9a-f]+ timer_high_readback=0x[0-9a-f]+ keyboard_low_readback=0x[0-9a-f]+ keyboard_high_readback=0x[0-9a-f]+ mouse_low_readback=0x[0-9a-f]+ mouse_high_readback=0x[0-9a-f]+",
