...
$expectedPatterns = @(
    ...
    "syscall_entry_typed=true",
    "syscall_flags_normalized=true",
    "syscall_flag_mask=0x700",
    ...
    "ELF segment mapped: .*perms=R-X .*segment_range_typed=true page_range_typed=true segment_heap_start_typed=true file_backed_range_typed=true",
    "ELF segment mapped: .*perms=R-- .*segment_range_typed=true page_range_typed=true segment_heap_start_typed=true file_backed_range_typed=true",
    "ELF segment mapped: .*perms=RW- .*segment_range_typed=true page_range_typed=true segment_heap_start_typed=true file_backed_range_typed=true",
    ...
    "fstat -> fd=",
    "getdents64 -> fd=",
    "brk -> task=.* mapped_pages=2 brk_request_typed=true heap_mapped_end_page_start_typed=true",
    "User heap pages unmapped: .*pages=1",
    "brk -> task=.* mapped_pages=1 brk_request_typed=true heap_mapped_end_page_start_typed=true",
    ...
    "User anonymous mapping unmapped: .*pages=1 records=2 active_pages=2 page_count_typed=true split_start_typed=true record_start_typed=true unmap_range_typed=true mapping_range_end_typed=true",
    "munmap -> task=.* pages=1 unmapped=true active_pages=2 active_records=2 unmap_request_typed=true unmap_length_typed=true page_count_typed=true",
    "User anonymous mapping unmapped: .*pages=1 records=1 active_pages=1 page_count_typed=true split_start_typed=true record_start_typed=true unmap_range_typed=true mapping_range_end_typed=true",
    "munmap -> task=.* pages=1 unmapped=true active_pages=1 active_records=1 unmap_request_typed=true unmap_length_typed=true page_count_typed=true",
    "User anonymous mapping unmapped: .*pages=1 records=0 active_pages=0 page_count_typed=true split_start_typed=true record_start_typed=true unmap_range_typed=true mapping_range_end_typed=true",
    "munmap -> task=.* pages=1 unmapped=true active_pages=0 active_records=0 unmap_request_typed=true unmap_length_typed=true page_count_typed=true",
    "mmap -> task=.* requested=0x600000008000 start=0x600000008000 length=4096 pages=1 .*flags=0x100022 placement=fixed_noreplace .*active_pages=1 .*mapping_request_typed=true mapping_length_typed=true mapping_start_typed=true mapping_range_typed=true fixed_placement_end_typed=true",
    "User mapping fixed replacement prepared: start=0x600000008000 pages=1 records=0 active_pages=0 mapping_range_typed=true mapping_range_end_typed=true",
    "mmap -> task=.* requested=0x600000008000 start=0x600000008000 length=4096 pages=1 .*flags=0x32 placement=fixed_replace .*active_pages=1 .*mapping_request_typed=true mapping_length_typed=true mapping_start_typed=true mapping_range_typed=true fixed_placement_end_typed=true",
    "munmap -> task=.* start=0x600000008000 length=4096 pages=1 unmapped=true active_pages=0 active_records=0 unmap_request_typed=true unmap_length_typed=true page_count_typed=true",
    ...
    "User file_private mapping unmapped: .*pages=1 records=0 active_pages=0 page_count_typed=true split_start_typed=true record_start_typed=true unmap_range_typed=true mapping_range_end_typed=true",
    "getppid -> parent=0",
    "user process ids ok",
