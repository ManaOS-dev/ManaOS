...
$expectedPatterns = @(
    ...
    "Concurrent user program spawn smoke passed: tasks=3",
    "Multi-user active set prepared: tasks=3",
    ...
    "Active user lifecycle drained: exits=3",
    ...
    "Wait lifecycle smoke passed: parent=0 retained_children=3 collected_children=3 double_reap_prevented=true",
    "Bootstrap child wait collection verified: parent=0 children=3",
    "Multi-user preemption smoke passed: tasks=3",
    "Scheduler diagnostics verified",
    "user_tasks\s+= 3",
    "active_user_tasks\s+= 0",
    "active_user_address_spaces\s+= 0",
    "pending_user_exits\s+= 0",
    "retained_user_exit_statuses\s+= 3",
    "waitable_user_exit_statuses\s+= 0",
    "collected_user_exit_statuses\s+= 3",
    "zombie_user_tasks\s+= 0",
    "reaped_user_tasks\s+= 3",
    "preemption_state\s+= enabled",
    "preemption_enabled\s+= true",
    "user_sleep_blocks\s+= 3",
    "user_sleep_wakes\s+= 3",
    "reclaimed_user_resource_records\s+= 3",
    "reclaimed_user_address_spaces\s+= 3",
    "reclaimed_user_pages\s+= 18",
    "reclaimed_user_page_table_pages\s+= 21",
    "reclaimed_user_kernel_stacks\s+= 3",
    "reclaimed_kernel_stack_writable_pages\s+= 12",
    "reclaimed_kernel_stack_virtual_pages\s+= 15",
    "timer_user_entries\s+= [1-9][0-9]*",
    "finished_tasks\s+= 3",
    "Scheduler task snapshots verified",
    "rows\s+= 5",
    "finished_user_tasks\s+= 3",
    "preempted_user_task_snapshots\s+= [1-9][0-9]*",
    "resumed_user_task_snapshots\s+= 3",
    "fully_reclaimed_user_tasks\s+= 3",
    "user_image_snapshots\s+= 3",
    "released_mmap_snapshots\s+= 3",
    ...
    "Tasks command smoke passed: command=`"tasks`" output_lines=21",
