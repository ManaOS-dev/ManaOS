...
$expectedPatterns = @(
    ...
    "User anonymous mapping unmapped: .*pages=1 records=2 active_pages=2 page_count_typed=true split_start_typed=true",
    "munmap -> task=.* pages=1 unmapped=true active_pages=2 active_records=2 unmap_request_typed=true page_count_typed=true",
    "User anonymous mapping unmapped: .*pages=1 records=1 active_pages=1 page_count_typed=true split_start_typed=true",
    "munmap -> task=.* pages=1 unmapped=true active_pages=1 active_records=1 unmap_request_typed=true page_count_typed=true",
    "User anonymous mapping unmapped: .*pages=1 records=0 active_pages=0 page_count_typed=true split_start_typed=true",
    ...
    "User file_private mapping unmapped: .*pages=1 records=0 active_pages=0 page_count_typed=true split_start_typed=true",
    "getppid -> parent=0",
    "user process ids ok",
