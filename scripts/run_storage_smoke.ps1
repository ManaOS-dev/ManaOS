...
$expectedPatterns = @(
    ...
    "Concurrent user program spawn smoke passed: tasks=4",
    "Multi-user active set prepared: tasks=4",
    ...
    "Active user lifecycle drained: exits=5",
    ...
    "retained_user_exit_statuses\s+= 5",
    "waitable_user_exit_statuses\s+= 0",
    "collected_user_exit_statuses\s+= 5",
    "zombie_user_tasks\s+= 0",
    "reaped_user_tasks\s+= 5",
    "preemption_state\s+= enabled",
    "preemption_enabled\s+= true",
    "user_sleep_blocks\s+= 4",
    "user_sleep_wakes\s+= 4",
    "user_waitpid_blocks\s+= 1",
    "user_waitpid_wakes\s+= 1",
    "reclaimed_user_resource_records\s+= 5",
    "reclaimed_user_address_spaces\s+= 5",
    "reclaimed_user_pages\s+= 40",
    "reclaimed_user_page_table_pages\s+= 35",
    "reclaimed_user_kernel_stacks\s+= 5",
    "reclaimed_kernel_stack_writable_pages\s+= 20",
    "reclaimed_kernel_stack_virtual_pages\s+= 25",
    "timer_user_entries\s+= [1-9][0-9]*",
    "finished_tasks\s+= 5",
    "Scheduler task snapshots verified",
    "rows\s+= 7",
    "finished_user_tasks\s+= 5",
    "bootstrap_child_user_tasks\s+= 4",
    "user_spawned_child_user_tasks\s+= 1",
    "preempted_user_task_snapshots\s+= [1-9][0-9]*",
    "resumed_user_task_snapshots\s+= 5",
    "fully_reclaimed_user_tasks\s+= 5",
    "user_image_snapshots\s+= 5",
    "released_mmap_snapshots\s+= 5",
    ...
    "Tasks command smoke passed: command=`"tasks`" output_lines=29",
