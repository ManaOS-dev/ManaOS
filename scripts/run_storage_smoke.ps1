...
$expectedPatterns = @(
    ...
    "unreplaced_user_image_snapshots\s+= 4",
    ...
    "retained_user_exit_statuses\s+= 7",
    "waitable_user_exit_statuses\s+= 0",
    "collected_user_exit_statuses\s+= 7",
    "zombie_user_tasks\s+= 0",
    "reaped_user_tasks\s+= 7",
    "preemption_state\s+= enabled",
    "preemption_enabled\s+= true",
    "user_sleep_blocks\s+= 5",
    "user_sleep_wakes\s+= 5",
    "user_waitpid_blocks\s+= 1",
    "user_waitpid_wakes\s+= 1",
    "reclaimed_user_resource_records\s+= 7",
    "reclaimed_user_address_spaces\s+= 7",
    "reclaimed_user_pages\s+= 56",
    "reclaimed_user_page_table_pages\s+= 49",
    "reclaimed_user_kernel_stacks\s+= 7",
    "reclaimed_kernel_stack_writable_pages\s+= 28",
    "reclaimed_kernel_stack_virtual_pages\s+= 35",
    "timer_user_entries\s+= [1-9][0-9]*",
    "finished_tasks\s+= 7",
    "Scheduler task snapshots verified",
    "rows\s+= 9",
    "finished_user_tasks\s+= 7",
    "bootstrap_child_user_tasks\s+= 6",
    "user_spawned_child_user_tasks\s+= 1",
    "preempted_user_task_snapshots\s+= [1-9][0-9]*",
    "resumed_user_task_snapshots\s+= 7",
    "fully_reclaimed_user_tasks\s+= 7",
    "user_image_snapshots\s+= 7",
    "released_mmap_snapshots\s+= 7",
    ...
    "Tasks command smoke passed: command=`"tasks`" output_lines=37",
