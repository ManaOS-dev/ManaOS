...
$expectedPatterns = @(
    ...
    "unreplaced_user_image_snapshots\s+= 5",
    ...
    "retained_user_exit_statuses\s+= 8",
    "waitable_user_exit_statuses\s+= 0",
    "collected_user_exit_statuses\s+= 8",
    "zombie_user_tasks\s+= 0",
    "reaped_user_tasks\s+= 8",
    ...
    "reclaimed_user_resource_records\s+= 8",
    "reclaimed_user_address_spaces\s+= 8",
    "reclaimed_user_pages\s+= 64",
    "reclaimed_user_page_table_pages\s+= 56",
    "reclaimed_user_kernel_stacks\s+= 8",
    "reclaimed_kernel_stack_writable_pages\s+= 32",
    "reclaimed_kernel_stack_virtual_pages\s+= 40",
    "timer_user_entries\s+= [1-9][0-9]*",
    "finished_tasks\s+= 8",
    "Scheduler task snapshots verified",
    "rows\s+= 10",
    "finished_user_tasks\s+= 8",
    "bootstrap_child_user_tasks\s+= 7",
    "user_spawned_child_user_tasks\s+= 1",
    "preempted_user_task_snapshots\s+= [1-9][0-9]*",
    "resumed_user_task_snapshots\s+= 8",
    "fully_reclaimed_user_tasks\s+= 8",
    "user_image_snapshots\s+= 8",
    "released_mmap_snapshots\s+= 8",
    ...
    "Tasks command smoke passed: command=`"tasks`" output_lines=41",
