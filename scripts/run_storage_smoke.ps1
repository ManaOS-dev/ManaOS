...
$expectedPatterns = @(
    ...
    "unreplaced_user_image_snapshots\s+= 6",
    ...
    "retained_user_exit_statuses\s+= 9",
    "waitable_user_exit_statuses\s+= 0",
    "collected_user_exit_statuses\s+= 9",
    "zombie_user_tasks\s+= 0",
    "reaped_user_tasks\s+= 9",
    "preemption_state\s+= enabled",
    "preemption_enabled\s+= true",
    "user_sleep_blocks\s+= 6",
    "user_sleep_wakes\s+= 6",
    "user_waitpid_blocks\s+= 2",
    "user_waitpid_wakes\s+= 2",
    "reclaimed_user_resource_records\s+= 9",
    "reclaimed_user_address_spaces\s+= 9",
    "reclaimed_user_pages\s+= 73",
    "reclaimed_user_page_table_pages\s+= 63",
    "reclaimed_user_kernel_stacks\s+= 9",
    "reclaimed_kernel_stack_writable_pages\s+= 36",
    "reclaimed_kernel_stack_virtual_pages\s+= 45",
    "timer_user_entries\s+= [1-9][0-9]*",
    "finished_tasks\s+= 9",
    "Scheduler task snapshots verified",
    "rows\s+= 11",
    "finished_user_tasks\s+= 9",
    "bootstrap_child_user_tasks\s+= 7",
    "user_spawned_child_user_tasks\s+= 2",
    "preempted_user_task_snapshots\s+= [1-9][0-9]*",
    "resumed_user_task_snapshots\s+= 9",
    "fully_reclaimed_user_tasks\s+= 9",
    "user_image_snapshots\s+= 9",
    "released_mmap_snapshots\s+= 9",
    ...
    "Tasks command smoke passed: command=`"tasks`" output_lines=45",
