...
$expectedPatterns = @(
    ...
    "User program spawned from filesystem: task=.* path=/disk/bin/file_demo argc=1",
    "spawn -> child=.* path=/disk/bin/file_demo stack_pages=4",
