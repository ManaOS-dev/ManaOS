...
$expectedPatterns = @(
    ...
    "Installed user task kernel stack: task=.* address_space=.* kernel_stack_top_typed=true architecture_stack_installer_typed=true",
    ...
    "User task entered from timer context: .*kernel_stack_top_typed=true architecture_stack_installer_typed=true",
    "User task resumed from timer context: .*kernel_stack_top_typed=true architecture_stack_installer_typed=true",
