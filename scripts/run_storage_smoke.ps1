...
$expectedPatterns = @(
    ...
    "User task exit status retained: parent=[1-9][0-9]* child=.* code=43 waitable=true",
    "Child exit record retained: parent=[1-9][0-9]* child=.* code=7 waitable=true",
    "Child exit record retained: parent=[1-9][0-9]* child=.* code=43 waitable=true",
    "Waitable child exit collected: parent=[1-9][0-9]* child=.* code=7",
    "Parent-exit child-live smoke passed: parent=[1-9][0-9]* child=.* parent_exit_before_child=true retained_parent=true status=11008 reparented=false",
    ...
    "bootstrap_child_user_tasks\s+= 5",
